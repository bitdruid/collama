...
export const decision_def = {
    ...
    function: {
        name: "decision",
        description:
            "Ask the user to choose between options when the right next step is ambiguous. Use this instead of guessing or stopping mid-task. The user's selected option is returned verbatim.",
        parameters: {
            type: "object",
            properties: {
                explanation: {
